/**
 * quay hot-reload client for Node.js
 *
 ...
 * Node.js applications that need to react to file changes broadcast by quay.
 *
 * Usage:
 *
 *   npm install ws
...
class HotReloadClient extends EventEmitter {
  ...
  /**
   * Open the WebSocket connection to the quay server.
   */
  connect() {
   ...
   * @param {string} filePath - Relative path from the quay root
  ...
  _log(msg) {
    console.log(`\x1b[35m[quay]\x1b[0m ${msg}`);
  }

  _warn(msg) {
    console.warn(`\x1b[33m[quay]\x1b[0m ${msg}`);
  }
}
...
if (require.main === module) {
  ...
  console.log(`quay Node.js hot-reload client`);
